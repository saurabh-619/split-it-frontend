...
class DeveloperPreview {
    ...
    var friendsWithPaymentInfo: [UserWithPaymentInfo] {
        var friends = [UserWithPaymentInfo]()
        for id in 1..<15 {
            friends.append(UserWithPaymentInfo(id: id, version: 1, username: "jon", firstName: "Jon", lastName: "Doe", email: "jon@gmail.com", avatar: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80", walletId: 1, wallet: nil, createdAt: "", updatedAt: "", deletedAt: "", paymentInfo: PaymentInfo(hasPaid: true, amount: 100))
            )
        }
        return friends
    }
